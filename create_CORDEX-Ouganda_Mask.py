...
model='HIRHAM5-v1_AFR-44_NCC-NorESM1-M_historical_tasmin_ll_2005_r.nc'
t_in = './' 
data = t_in + model 
...
mask.to_netcdf('./mask_AFR44_by_countries.nc')

mask_ouganda = mask.where(mask==758)/mask.where(mask==758)
mask_ouganda.to_netcdf('./mask_AFR44_Ouganda.nc')
...
plt.savefig('OUGANDA_CORDEX-AFR44_Mask.png', bbox_inches='tight', pad_inches=0.1)
plt.show()   